...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    operatorController.a().whileTrue(new LaunchSpeaker(shooterSubsystem).withTimeout(1).andThen(null).handleInterrupt(() -> shooterSubsystem.stop()));
    operatorController.b().whileTrue(new LaunchAmp(shooterSubsystem).withTimeout(1).andThen(null).handleInterrupt(() -> shooterSubsystem.stop()));
